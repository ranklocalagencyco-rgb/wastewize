...
export const townSeo: Record<string, TownSeo> = {
  ...
  'berkshire/reading': {
    postcode: 'RG1 / RG2 / RG3',
    metaDesc: 'Commercial waste management and office clearance in Reading RG1, RG2, RG3. WasteWize UK provides high-volume trade waste, strip-outs, and specialist disposal for Reading businesses.',
    intro: "Reading is one of the UK's most significant commercial centres outside London, with a major retail district, extensive office quarter, and growing residential development generating the highest commercial waste volumes in Berkshire. WasteWize UK provides enterprise-scale waste management across Reading — from high-frequency trade collections and office strip-outs to construction clearance and specialist disposal.",
  },
  ...
  'berkshire/windsor': {
    postcode: 'SL4',
    metaDesc: 'Commercial waste collection and sensitive clearances in Windsor SL4. WasteWize UK serves Windsor town centre, the Castle environs, and surrounding estates — EA licensed.',
    intro: "Windsor's global profile as a royal and heritage destination, combined with its busy town centre, retail quarter, and hospitality sector, creates year-round demand for professional, discreet waste management. WasteWize UK provides commercial collections, confidential waste shredding, and sensitive clearances across Windsor — compliant with the town's conservation requirements.",
  },
  ...
  'west-london/hammersmith': {
    postcode: 'W6',
    metaDesc: 'Commercial waste collection and strip-out services in Hammersmith W6. WasteWize UK serves Hammersmith offices, retail units, and development sites — EA licensed, fast turnaround.',
    intro: "Hammersmith is a major west London commercial hub, home to major corporate headquarters, retail centres, and an active development pipeline along the riverside. WasteWize UK provides office clearances, construction waste removal, and scheduled trade collections for Hammersmith W6 businesses and contractors, with same-week availability and full compliance documentation.",
  },
  ...
  'west-london/notting-hill': {
    postcode: 'W11',
    metaDesc: 'Commercial waste collection and end-of-tenancy clearance in Notting Hill W11. WasteWize UK serves Portobello Road traders, restaurants, and residential properties — EA licensed.',
    intro: "Notting Hill's vibrant Portobello Road market, independent restaurants, and high-end residential streets create diverse waste management needs throughout the W11 postcode. WasteWize UK provides flexible, discreet collections for Notting Hill businesses and homeowners — including end-of-tenancy clearances, garden waste removal, and trade waste management for the hospitality sector.",
  },
